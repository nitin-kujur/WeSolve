			...
			<div class="col-md-5 padding-25">
				<!-- <div class="row"> -->
					...
					<div class="w3-white col-md-12 col-sm-12 col-xs-12 w3-card-1 padding-15">
						<br/>
						<img class="img-responsive center-block img-circle text-center" alt="No Pic" style="max-width:180px; height:180px; display:block; line-height:180px; white-space:pre; background:#4a90e2; color:white; text-shadow: #444 0 1px 1px;" src="images/default/female-<?php echo rand(1, 5); ?>-default.jpg" >	
