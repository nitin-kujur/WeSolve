                ...
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">
                             Challanges
                            <small>How do we price and segment the market for a 2017...</small>
                        </h1>
                        <ol class="breadcrumb w3-card-1">
                            ...
                            <li>
                                <i class="fa fa-tasks"></i>  Challanges
                            </li>
                            <li class="active">
                                <i class="fa fa-plus"></i> Manage Challange
                            </li>
                        </ol>
                    </div>
                </div>
                  ...
                  <form class="form-horizontal" role="form" method="POST">
                    ...
                    <div class="col-lg-12">
                       <div class="row breadcrumb1 1w3-card-1 w3-margin w3-clear">
                        <div class="col-md-12">
                          <button type="button" class="w3-orange pull-right w3-btn  w3-round-large w3-text-white" onclick="window.location.assign('admin_manage_challenges.php');">Back</button>
