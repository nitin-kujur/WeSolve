			  ...
			  <div class="container-fluid">
				...
				<div class="collapse navbar-collapse" id="myNavbar">
					<ul class="nav navbar-nav navbar-right">
					  ...
					  <li class="hidden-sm hidden-xs">&nbsp;&nbsp;</li>
					  <li><h6 class="text-center"><a href="companies_and_challenges.php"><button class="w3-btn w3-round w3-card-2 w3-padding-large w3-light-gray w3-text-dark-blue w3-border-dark-blue nav-btn-top">FOR COMPANIES</button></a></h6></li>
					  <li class="hidden-sm hidden-xs">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</li>
