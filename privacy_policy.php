	...
	<div class="container w3-padding-01">
		<div class="row">
			<div class="col-xs-12">
				...
				<p class="font_8">Our primary goals in collecting, using and processing information via the Platform are to provide Users with access to and use of our Platform, to improve and further develop our Platform and to enable users to enjoy and easily navigate the Site.</p>

				<p class="font_8">Personally Identifiable Information</p>

				<ul class="font_8">
					<li>
					<p class="font_8">In the course of using the Platform (whether as a Company &nbsp;or Company), we may ask you to provide us with, or grant us access to, or permission to obtain, certain personally identifiable information that can be used to contact or identify you; personally identifiable information may include, but is not limited to, your name, company name, email address, postal address, work experience and interests, and phone number (”Information“).</p>
					</li>
					<li>
					<p class="font_8">If you use the Platform to make or receive payments, we will also collect certain Personal Information such as credit card information, Swipe, PayPal or other financial account information, and billing address.</p>
					</li>
					<li>
					<p class="font_8">We may collect additional Personal Information to validate your identity, such as your date of birth, place of birth or taxpayer identification number. We may request documents to verify this information, such as a copy of your government-issued identification or photo, and we may authenticate it against third party databases or request a credit report.</p>
					</li>
					<li>
					<p class="font_8">As further described in our Terms of Service, you may register or input data onto our Platform directly via the Site or by logging into your account with certain third party social networking services (including, but not limited to, LinkedIn or Facebook) (“SNS”) via our Site. If you choose to input data via an SNS, we will use the Personal Information you have provided to the SNS (such as your ”real” name, email address, gender, prior experience and other information you make publicly available via the SNS) to modify and update your account; the information we extract may depend on the privacy settings you have with the SNS. Other than what we may share with the SNS as described below, the Personal Information an SNS has about you is obtained by the SNS independent of our Platform, and WeSolv is not responsible for its accuracy, legality, or non-infringement.</p>
					</li>
					<li>
					<p class="font_8">You may link your WeSolv account to your SNS account, in which case the SNS may share certain information about you with other SNS users, as well as sharing certain information about other SNS users with you. You represent that you are authorized to use your SNS account for the purposes described herein without breach by you of any of the terms and conditions that govern the SNS, and without obligating WeSolv to pay any fees or making WeSolv subject to any usage limitations imposed by such SNS. You can disable the link between your WeSolv account and your SNS account at any time though the “Settings” section of the Site. PLEASE NOTE THAT YOUR RELATIONSHIP WITH ANY SNS IS GOVERNED SOLELY BY YOUR AGREEMENT(S) WITH SUCH SNS. If your SNS account terminates, then functions enabled through the link between your WeSolv account and your SNS account will terminate as well.</p>
					</li>
					<li>
					<p class="font_8">We also collect other information that you provide in connection with your use of the Platform (e.g., zip code (on its own) and individual preferences) (“Non-Identifying Information”). We collect additional Non-Identifying Information from Company s in the form of information related to jobs posted via the Platform (e.g., budget, location, history of job listings, timing of job performance and feedback/rating information). We also collect additional Non-Identifying Information from Students in connection with Student profiles (e.g., information on jobs previously performed, skills, tests taken, hourly pay rates and feedback/rating information).</p>
					</li>
					<li>
					<p class="font_8">We use your Personal Information (in some cases, in conjunction with your Non-Identifying Information) mainly to provide the Platform, complete your transactions, and administer your inquiries.</p>
					</li>
				</ul>

				<p class="font_8">Certain Non-Identifying Information would be considered a part of your Personal Information if it were combined with other identifiers (for example, combining your zip code with your street address) in a way that enables you to be identified. But the same pieces of information are considered Non-Identifying Information when they are taken alone or combined only with other non-identifying information (for example, your viewing preferences). We may combine your Personal Information with Non-Identifying Information and aggregate it with information collected from other WeSolv Users to attempt to provide you with a better experience, to improve the quality and value of the Platform, and to analyze and understand how our Site and Platform are used, and to generate general industry analysis. We may also use the combined information without aggregating it to serve you specifically, for instance to deliver a product to you according to your preferences or restrictions.</p>
				...
				<ul class="font_8">
					<li>
					<p class="font_8">To provide our products and the Platform,</p>
					</li>
					<li>
					<p class="font_8">For billing, identification and authentication, and fraud prevention,</p>
					</li>
					<li>
					<p class="font_8">To analyze Site usage and improve our products and the Platform,</p>
					</li>
					<li>
					<p class="font_8">To contact you and deliver administrative notices and communications relevant to your use our products and services,</p>
					</li>
					<li>
					<p class="font_8">For internal market research, troubleshooting problems, and detecting and protecting against error, fraud or other criminal activity,</p>
					</li>
					<li>
					<p class="font_8">To allow Companies to contact you for employment purposes</p>
					</li>
					<li>
					<p class="font_8">For distribution to third-party Students that provide services to WeSolv and partners of WeSolv who are bound by confidentiality obligations with respect to any Personal Information that we share with them.</p>
					</li>
					<li>
					<p class="font_8">To enforce our Terms of Service, and</p>
					</li>
					<li>
					<p class="font_8">As otherwise set forth in the Privacy Policy.</p>
					</li>
				</ul>
				...
				<p class="font_8">WeSolv may analyze Personal Information and Web Navigational Data based on your interests and may use the analysis from this information in a way that does not contain any Personal Information (“Market Research”) in order to:</p>

				<ul class="font_8">
					<li>
					<p class="font_8">Market the Platform</p>
					</li>
					<li>
					<p class="font_8">Improve the likelihood of a sale to a new Users</p>
					</li>
					<li>
					<p class="font_8">Increase the likelihood that a User's experience with the Platform is relevant to its interests</p>
					</li>
				</ul>

				<p class="font_8">WeSolv uses data at the individual level to sell products and services to Users who express an interest in these products and services, through a poll for example, or to Users who can be presumed to have an interest based on results from our Market Research.</p>
				...
				<ul class="font_8">
					<li>
					<p class="font_8">When you submit information to WeSolv, it is collected, processed and maintained solely by us or by third party Agents who are bound by confidentiality obligations. We may allow our business partners to collect information about Users that is not extremely sensitive Information. If you would like to opt out from the onward transfer of your information to our non-agent partners, you may send us an email at info@WeSolv.co. Include the word ”privacy” in the subject line of the email and all your registration information in the body of the email.</p>
					</li>
					<li>
					<p class="font_8">We may share or otherwise use aggregated information that does not include Personal Information and we may otherwise disclose Non-Identifying Information and Log Data with third parties for industry analysis, demographic profiling and other purposes. Any aggregated information shared in these contexts will not contain your Personal Information.</p>
					</li>
					<li>
					<p class="font_8">Some WeSolv content is “sponsored by” or “presented by” other companies. WeSolv shares market research data (how the sponsorship performed, names of contest winners, etc.) collected on this website or via email surveys with these partners. This information is aggregated and not linked to specific Users.</p>
					</li>
					<li>
					<p class="font_8">Partners may sponsor promotions, contests and sweepstakes that require you to reveal details such as your name, address or phone number. When a Partner-sponsored contest or sweepstakes is made available through our Platform, it will contain a link to the Partnerʼs privacy policy. Always check their privacy policy before revealing information about yourself. If you don't want these sponsors to have your Personal Information, you can choose to not participate in their contests, sweepstakes and other offerings.</p>
					</li>
					<li>
					<p class="font_8">WeSolv reserves the right to disclose Personal Information from both private and public areas of this website at our discretion, if required by law or if we are given reason to believe, in our sole discretion, that such disclosure is necessary in order to prevent harm to our Platform or our Users or to protect the rights of our Users, the general public, or WeSolv, to comply with a judicial proceeding, court order or legal process.</p>
					</li>
					<li>
					<p class="font_8">Finally, WeSolv reserves the right to transfer, sell and/or distribute all information collected through the Platform to an affiliate, subsidiary, or third party in the event of any reorganization, merger, sale, joint venture, assignment, transfer or other disposition of all or part of our business, assets or stock. We will require that new entity follows this Privacy Policy with respect to your Personal Information, as and to the extent required by applicable law, unless and until you consent to a different privacy policy of the new entity.</p>
					</li>
				</ul>
				...
				<p class="font_8">Identity theft and the practice currently known as ”phishing” are of great concern to WeSolv. Safeguarding information to help protect you from identity theft is a top priority. We do not and will not, at any time, request your credit card information, your account ID, login password, or national identification numbers in a non-secure or unsolicited e-mail or telephone communication. We suggest advise you not to respond to and to promptly report any email or telephone communication purporting to be from WeSolv in which such information is collected. For more information about phishing, visit the Federal Trade Commission’s website.</p>
				...
				<p class="font_8">If you have any questions about this Privacy Policy, please contact us by email at <span style="text-decoration:underline;"><a href="mailto:info@WeSolv.co?subject=Privacy Policy Questions" target="_self" data-content="info@WeSolv.co" data-type="mail">info@WeSolv.co</a></span></p>
			</div>
		</div>
	</div>
