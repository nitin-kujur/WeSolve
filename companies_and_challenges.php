			  		...
			  		<h2 class="w3-text-white col-md-12 col-sm-12 col-xm-12 w3-jumbo" style=""><b>WeSolv at a Glance</b></h2>  		
						...
						<div id="" class="table-responsive w3-text-dark-blue w3-section w3-margin-top" style="">
								<table id="datatable" class="table">
									<tr>
										<td></td>
										<td><button class="w3-btn cc-btn w3-xlarge w3-dark-blue"><b>WeSolv</b></button></td>
										<td><button class="w3-btn cc-btn w3-xlarge w3-light-orange"><b>Case<br>Competitions</b></button></td>
										<td><button class="w3-btn cc-btn w3-xlarge w3-light-blue"><b>Campus<br>Recruiting</b></button></td>
										<td><button class="w3-btn cc-btn w3-xlarge w3-light-orange"><b>Diversity<br>Orgs</b></button></td>
									</tr>
									<tr>
										<td></td>
										<td></td>
									...
									<tr>
										...
										<td class="w3-xxlarge text-center w3-text-blue"><i class="fa fa-check"></i></td>
										<td class="w3-xxlarge text-center w3-text-blue"><i class="fa fa-check"></i></td>
										<td class="w3-xxlarge text-center w3-text-blue"><i class="fa fa-check"></i></td>
										<td class="w3-xxlarge text-center w3-text-blue"><i class="fa fa-check"></i></td>
									</tr>
									<tr>
										...
										<td class="w3-xxlarge text-center w3-text-blue"><i class="fa fa-check"></i></td>
										<td class="w3-xxlarge text-center w3-text-blue"><i class="fa fa-check"></i></td>
										<td class="w3-xxlarge text-center w3-text-red"><i class="fa fa-times"></i></td>
										<td class="w3-xxlarge text-center w3-text-red"><i class="fa fa-times"></i></td>
									</tr>
									<tr>
					...
					<div class="row">
						...
						<div class="col-md-10 w3-padding-0">
							<div class="owl-carousel-mba w3-section">
								<div class="item">
										<img src="images/Group 15p.png" class="img-responsive center-block img-circle"  alt="p" width="180" height="auto" style="object-fit: contain;">
								</div>
								
								<div class="item">
										<img src="images/Michigan_Ross.png" class="img-responsive center-block"  alt="p" width="180" height="auto" style="object-fit: contain;">
								</div>
								
								<div class="item">
										<img src="images/Duke.png" class="img-responsive center-block"  alt="p" width="180" height="auto" style="object-fit: contain;">
								</div>

								<div class="item">
										<img src="images/Kellogg.png" class="img-responsive center-block"  alt="p" width="180" height="auto" style="object-fit: contain;">
								</div>
								
								<div class="item">
										<img src="images/temple fox.png" class="img-responsive center-block"  alt="p" width="180" height="auto" style="object-fit: contain;">
								</div>
							</div>
							<!-- <br> -->
							<div class="owl-carousel-mba w3-section w3-margin-top">
								<div class="item">
										<img src="images/UCLAA.png" class="img-responsive center-block"  alt="p" width="180" height="auto" style="object-fit: contain;">
								</div>
								
								<div class="item">
										<img src="images/wharton.png" class="img-responsive center-block"  alt="p" width="180" height="auto" style="object-fit: contain;">
								</div>
								
								<div class="item">
										<img src="images/Virginia.png" class="img-responsive center-block"  alt="p" width="180" height="auto" style="object-fit: contain;">
								</div>
								
								<div class="item">
										<img src="images/Kelly business.png" class="img-responsive center-block"  alt="p" width="180" height="auto" style="object-fit: contain;">
								</div>
			...
			<div class="jumbotron w3-blue view-height top-margin">
			  <div class="container text-center">
				...
				<div class="row">
					...
					<div class="col-md-2 hidden-sm hidden-xs text-right  pa-height"><h1>&nbsp;</h1><a href="javascript:void(0);" class="next"><h1 class="w3-text-dark-blue w3-jumbo ver-cent"><i class="fa fa-angle-right"></i></h1></a></div>
				</div>
			  </div>
			  <br/>
			</div>
