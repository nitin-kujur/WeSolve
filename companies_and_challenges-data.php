				...
				<div class="col-md-5 col-sm-5 col-xs-12 padding-25 col-height">  <!-- col 8 start -->
					<div class="container w3-border-light-orrange w3-bottombar" style="height:100%;">
						<div class="row">
							...
							<div class="col-xs-6">
								<h6 class="">Charlotte, North Carolina</h6>
								<h6 class="">San Francisco, California</h6>
								<h6 class="">New York, New York</h6>
								<h6 class="">Chicago, Illinois</h6>
								<h6 class="">Los Angeles, California</h6>
							</div>
						</div>
						<div class="container text-center w3-section">
							<a class="w3-text-orange w3-large" data-toggle="modal" href="#signupModal"><u>Check out Challenge</u></a>						
				...
				<div class="col-md-5 col-sm-5 col-xs-12 padding-25 col-height">  <!-- col 4 start -->
					<div class="container w3-border-light-orrange w3-bottombar" style="height:100%;">
						<div class="row">
							...
							<div class="col-xs-6">
								<h6 class="">Redmond, Washington</h6>
							</div>
						</div>
						<div class="container text-center w3-section">
							<a class="w3-text-orange w3-large" data-toggle="modal" href="#signupModal"><u>Check out Challenge</u></a>						
				...
				<div class="col-md-5 col-sm-5 col-xs-12 padding-25 col-height">  <!-- col 8 start -->
					<div class="container w3-border-light-orrange w3-bottombar" style="height:100%;">
						<div class="row">
							...
							<div class="col-xs-6">
								<h6 class="">Cupertino, California</h6>
							</div>
						</div>
						<div class="container text-center w3-section">
							<a class="w3-text-orange w3-large" data-toggle="modal" href="#signupModal"><u>Check out Challenge</u></a>						
				...
				<div class="col-md-5 col-sm-5 col-xs-12 padding-25 col-height">  <!-- col 4 start -->
					<div class="container w3-border-light-orrange w3-bottombar" style="height:100%;">
						<div class="row">
							...
							<div class="col-xs-6">
								<h6 class="">Seattle Washingtion</h6>
							</div>
						</div>
						<div class="container text-center w3-section">
							<a class="w3-text-orange w3-large" data-toggle="modal" href="#signupModal"><u>Check out Challenge</u></a>						
				...
				<div class="col-md-5 col-sm-5 col-xs-12 padding-25 col-height">  <!-- col 4 start -->
					<div class="container w3-border-light-orrange w3-bottombar" style="height:100%;">
						<div class="row">
							...
							<div class="col-xs-6">
								<h6 class="">Bloomington, Illinois</h6>
								<h6 class="">Chicago, Illinois</h6>
							</div>
						</div>
						<div class="container text-center w3-section">
					...
					<div class="container w3-border-light-orrange w3-bottombar" style="height:100%;">
						<div class="row">
							...
							<div class="col-xs-6">
								...
								<h6 class="">Los Angeles, California</h6>
								<h6 class="">Chicago, Illinois</h6>
								<h6 class="">Houston, Texas</h6>
								<h6 class="">Washington DC</h6>
							</div>
						</div>
						<div class="container text-center w3-section">
							<a class="w3-text-orange w3-large" data-toggle="modal" href="#signupModal"><u>Check out Challenge</u></a>						
