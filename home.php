		    ...
		    <div class="modal-dialog">
		        <div class="modal-content">
		            <div class="modal-body">
		                ...
		                <div>
		                    <iframe class="w3-card-2" width="100%" height="320" src=""></iframe>
		                </div>
		            </div>
		        </div>
		    </div>
			  ...
			  <div class="container text-center">
						...
						<div class="row">
								...
								<div class="col-md-3 col-sm-6 col-xs-6 text-center">
										<button class="w3-btn w3-round w3-card-2 w3-padding-large w3-orange w3-text-white">FOR STUDENTS</button><br/>
								</div>
								<div class="col-md-3 col-sm-6 col-xs-6 text-center">
			  ...
			  <div class="container-fluid w3-padding-0">
				...
				<div class="container">
					<div class="owl-carousel-media">
							<div class="item">
									<img src="images/chicago inno.png" class="img-responsive"  alt="p" width="auto" height="180" style="object-fit: contain;">
							</div>
							<div class="item">
									<img src="images/made mag.png" class="img-responsive"  alt="p" width="auto" height="180" style="object-fit: contain;">
							</div>
							<div class="item">
									<img src="images/poets _ quants.png" class="img-responsive"  alt="p" width="auto" height="180" style="object-fit: contain;">
							</div>
							<div class="item">
