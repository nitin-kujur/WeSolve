            ...
            <div class="container-fluid">
                ...
                <div class="row">
                  <form class="form-horizontal" role="form" method="POST">
                            ...
                            <div class="row">
                                <div class="col-lg-6">
                                   <div class="row w3-margin-bottom">
                                     ...
                                     <div class="col-xs-7">
                                       <input type="text" class="form-control datepicker" name="ThirdPrize" placeholder="Enter Entry Deadline">
                                     </div>
                                   </div>
                                   <div class="row w3-margin-bottom">
                                     <div class="col-xs-5">
                                     ...
                                     <div class="col-xs-7">
                                       <input type="text" class="form-control datepicker" name="ThirdPrize" placeholder="Enter Start Date">
                                     </div>
                                   </div>
                                   <div class="row w3-margin-bottom">
                                     <div class="col-xs-5">
                                     ...
                                     <div class="col-xs-7">
                                       <input type="text" class="form-control datepicker" name="ThirdPrize" placeholder="Enter Winner Selection">
                                     </div>
                                  </div>
                                </div>
                                <div class="col-lg-6">
                                   <div class="row w3-margin-bottom">
                                     ...
                                     <div class="col-xs-7">
                                       <input type="text" class="form-control datepicker" name="ThirdPrize" placeholder="Enter Application Notification">
                                     </div>
                                   </div>
                                   <div class="row">
                                     <div class="col-xs-5">
                                     ...
                                     <div class="col-xs-7">
                                       <input type="text" class="form-control datepicker" name="ThirdPrize" placeholder="Enter Due Date">
                                     </div>
                                  </div>
                                </div>
                            </div>
                    ...
                    <div class="col-lg-12">
                        <div class="row breadcrumb w3-card-1 margin-0">
                             <label class="w3-padding-0">Add Winners</label>
                                ...
                                <div class="col-xs-12 w3-margin-bottom">
                                 ...
                                 <div class="col-xs-8 w3-margin-bottom">
                                   <div class="row">
                                    ...
                                    <div class="col-xs-6">
                                        <input type="text" class="form-control" name="ThirdPrize" placeholder="Enter Year">
                                    </div>
                                   </div>
                                 </div>
                             </div>
                             ...
                             <div class="row w3-margin-bottom">
                              <div class="col-xs-12 w3-margin-bottom">
                                <label class="w3-padding-0 w3-margin-bottom">Winner List</label>
