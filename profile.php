			...
			<div class="col-md-5 padding-25">
				<!-- <div class="row"> -->
					...
					<div class="w3-white col-md-12 col-sm-12 col-xs-12 w3-card-1 padding-15">
						...
						<h2 class="w3-text-dark-blue col-md-9  col-sm-9 col-xs-9">Stella Bobo</h2>	<a href="#" class="w3-text-grey w3-hover-text-blue text-right col-md-3 col-sm-3 col-xs-3"><h2><i class="fa fa-pencil" style="font-size:24px"></i></h2></a>		
					...
					<div class="w3-white col-md-12 col-sm-12 col-xs-12 w3-card-1 padding-15">
						...
						<h6 class="w3-text-black col-md-6  col-sm-6 col-xs-6">SKILLS</h6><a href="#" class="w3-text-grey w3-hover-text-blue text-right col-md-3 col-sm-3 col-xs-3 pull-right"><i class="fa fa-pencil" style="font-size:24px"></i></a>		
						<br/><br/>
						<form role="form">
						  <div class="form-group">
						  	<div class="col-md-12 col-sm-12 col-xs-12" style="display:inline-block; position:relative;">
						  			<textarea class="form-control w3-text-black" id="skills" resize="none"></textarea> <br/>
			...
			<div class="col-md-7 padding-25">
				<!-- <div class="row"> -->
					...
					<div class="w3-white col-md-12 col-sm-12 col-xs-12 w3-card-1 padding-15">
						...
						<br/><br/>
						<div class="col-md-12 col-sm-12 col-xs-12 w3-light-grey padding-15">
								<form role="form">
							    <div class="form-group">
							    ...
							    <div class="form-group">
								    	...
								    	<div class="row w3-padding-0">
							    			<div class="col-md-6 col-sm-6 col-xs-6 col-md-offset-6 text-center">
								    				<span class=""><a class="w3-text-blue" href="#">Remove this position</a></span>	
							    			</div>
								    	</div>
